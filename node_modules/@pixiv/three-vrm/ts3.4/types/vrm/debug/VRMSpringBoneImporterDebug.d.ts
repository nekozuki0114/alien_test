...
export declare class VRMSpringBoneImporterDebug extends VRMSpringBoneImporter {
    ...
    protected _createSpringBone(bone: THREE.Object3D, hitRadius: number, stiffiness: number, gravityDir: THREE.Vector3, gravityPower: number, dragForce: number, colliders?: THREE.Mesh[]): VRMSpringBoneDebug;
}
